...
*/
DROP DATABASE IF EXISTS aWiki;

CREATE DATABASE IF NOT EXISTS aWiki
...
CREATE TABLE `Posts` (
  ...
  `ModifiedTime`   VARCHAR(50) NOT NULL,
  `ModifiedPerson` INTEGER,
...
VALUES (NULL, 'Books', 'Latest IT books', 'books', 'books.png');
INSERT INTO Categories
...
INSERT INTO Posts
VALUES (NULL, 1, 2, 'Test Posts', 'image.png', 'Content', 'test-posts', DATE(NOW()), NULL, NULL, 1);
...
INSERT INTO Users
VALUES (NULL, 'Anh', 'Pham', '02650', 'anhpham@awiki.com', 'anhpham',
        '$2a$10$mpJCYlSr762SwQVzdLwxR.KgRuWEHA2NzUanxxG/nxEStDRcRBbB6', 1);
INSERT INTO Users
VALUES
  (NULL, 'Anh Pham', 'Vanha Maantie 8', '02650', 'Helsinki', 'Finland', '012 345 6787', 'anh.pham@astore.com',
         'anhpham', '$2a$10$TsD7IW0m1g/57C931nC7R.FjwXw9i0tAbJZk7u4Uk0gDoneR9yBim',
         0);
